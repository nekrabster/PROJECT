...
class ColorGenerator:
    ...
    def generate_theme_palette(is_dark):
        ...
        if is_dark:
            bg = f"qradialgradient(cx:0.3, cy:0.5, radius:1.1, fx:0.3, fy:0.5, stop:0 rgba({base_color.lighter(500).red()},{base_color.lighter(500).green()},{base_color.lighter(500).blue()},210), stop:0.12 rgba({base_color.lighter(300).red()},{base_color.lighter(300).green()},{base_color.lighter(300).blue()},220), stop:0.25 rgba({base_color.lighter(200).red()},{base_color.lighter(200).green()},{base_color.lighter(200).blue()},230), stop:0.40 rgba({base_color.darker(100).red()},{base_color.darker(100).green()},{base_color.darker(100).blue()},240), stop:0.60 rgba({base_color.darker(200).red()},{base_color.darker(200).green()},{base_color.darker(200).blue()},245), stop:0.80 rgba({base_color.darker(300).red()},{base_color.darker(300).green()},{base_color.darker(300).blue()},250), stop:1 rgba({base_color.darker(400).red()},{base_color.darker(400).green()},{base_color.darker(400).blue()},255))"
        else:
