...
""")
        ...
        update_html = (
            "<b>🚀 Soft-K: Революционное обновление 2.3.9!</b><br>"
            "<br>"
            "<span style='color:#1976d2;'>🔥 <strong>Невероятный прорыв в производительности:</strong> прирост скорости на <strong>209%</strong> благодаря глубокой оптимизации алгоритмов памяти!</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>⚡ <strong>Революция в управлении ОЗУ:</strong> пятикратное улучшение работы с оперативной памятью — теперь софт работает молниеносно даже на слабых машинах.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🤖 <strong>Автоответы нового поколения:</strong> кардинально переработанная архитектура обеспечивает мгновенную реакцию и стабильность в любых условиях.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🎨 <strong>Умная тематизация:</strong> алгоритм генерации цветов и переключения ночной темы оптимизирован до предела — интерфейс отзывается мгновенно.</span><br>"
            "<br>"
            "<span style='color:#e53935;'>🆕 <strong>НОВИНКА - Серверные автоответы (БЕТА):</strong> добавлено новое окно — клон автоответов, работающий в серверном режиме! Используйте его для прогрева 1-2 ботов для тестирования. Пока это бета-версия для публичного бета-тестирования. Основное окно автоответов сохранено — НЕ используйте одновременно!</span><br>"
            "<br>"
            "<span style='color:#388e3c;'>🔬 <strong>Активное тестирование:</strong> благодаря вашим активным тестам данный модуль в скором времени будет работать на сервере бесперебойно!</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🔧 <strong>Стабильность и производительность:</strong> исправлены мелкие ошибки и добавлены дополнительные улучшения производительности для еще более плавной работы.</span><br>"
        )
