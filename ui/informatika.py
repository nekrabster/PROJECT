...
""")
        ...
        update_html = (
            "<b>🚀 Soft-K: Стабильная версия 2.3.9!</b><br>"
            "<br>"
            "<span style='color:#1976d2;'>🔧 <strong>Исправления и оптимизация:</strong> устранены критические ошибки в системе обновлений для более стабильной работы.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>⚡ <strong>Улучшенная система обновлений:</strong> новый надежный механизм автообновления с детальной обратной связью пользователю.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🛡️ <strong>Повышенная стабильность:</strong> исправлены проблемы с заменой исполняемых файлов при обновлении.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🎯 <strong>Оптимизация производительности:</strong> улучшена работа с памятью и ускорена загрузка интерфейса.</span><br>"
            "<br>"
            "<span style='color:#388e3c;'>✅ <strong>Протестированные улучшения:</strong> все изменения прошли тщательное тестирование для обеспечения максимальной стабильности.</span><br>"
            "<br>"
            "<span style='color:#e53935;'>🆕 <strong>Серверные автоответы (БЕТА):</strong> продолжается активное развитие серверного режима автоответов. Используйте для тестирования 1-2 ботов.</span><br>"
            "<br>"
            "<span style='color:#1976d2;'>🔄 <strong>Рекомендации:</strong> данная версия рекомендуется для всех пользователей как стабильное обновление с важными исправлениями.</span><br>"
        )
