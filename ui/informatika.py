...
""")
        ...
        update_html = (
            "<b>🚀 Soft-K: Новое обновление 2.3.6!</b><br>"
            "<br>"
            "<span style='color:#1976d2;'>1. Реализован трансфер — теперь можно менять владельца бота прямо в таблице сессий.</span><br>"
            "<span style='color:#1976d2;'>2. Оптимизация памяти и прирост производительности во всех модулях.</span><br>"
        )
