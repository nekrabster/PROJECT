...
class SessionManagerWindow(BaseTableManager):
    ...
    def setup_ui(self, *args):
        ...
        folder_icon_path = resource_path("icons/papka.png")
        if os.path.exists(folder_icon_path):
            self.create_folder_btn.setIcon(QIcon(folder_icon_path))
        ...
        move_icon_path = resource_path("icons/papka1.png")
        if os.path.exists(move_icon_path):
            self.move_sessions_btn.setIcon(QIcon(move_icon_path))
    ...
    def load_sessions(self, *args):
        ...
        for i, session in enumerate(sessions):
            try:
                ...
                edit_icon_path = resource_path("icons/icon113.png")
